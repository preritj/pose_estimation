...
@slim.add_arg_scope
def inverted_residual_bottleneck(inputs, depth, stride, expand_ratio, scope=None):
            ...
            for i, conv_def in enumerate(conv_defs):
                ...
                if isinstance(conv_def, Conv):
                    ...
                    for n in range(conv_def.num):
                        ...
                        net = inverted_residual_bottleneck(net, depth(conv_def.depth), stride, conv_def.t,
                                                           scope=end_point)
                        end_points[end_point] = net
                        if end_point == final_endpoint:
                            return net, end_points
